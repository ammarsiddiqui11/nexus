...
const TESTIMONIALS = [
  {
    ...
    text: 'LeapUp Digital completely transformed how we think about our digital presence. The dashboard they built handles 50k concurrent users without breaking a sweat. Their attention to performance is unmatched.',
    rating: 5,
    avatar: 'SC',
  },
  {
  ...
  },
  {
    ...
    text: 'Building HIPAA-compliant software is hard. Finding a team that understands both the technical and regulatory requirements is rare. LeapUp Digital delivered a system we trust with patient data.',
    rating: 5,
    avatar: 'PN',
  },
  {
    ...
    company: 'BuilderOS',
    text: 'I\'ve worked with a lot of agencies. Most overpromise and underdeliver. LeapUp Digital did the opposite — the final product exceeded our expectations on every metric we cared about.',
    rating: 5,
    avatar: 'JM',
  },
]
